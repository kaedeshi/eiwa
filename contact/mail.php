...
$site_top = "https://kaedeshi.github.io/eiwa/";

//管理者のメールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "kamekame.com.0726111@gmail.com";
...
$require = array('お問い合わせ種別','お名前','メールアドレス','確認用メールアドレス','電話番号','お問い合わせ内容','個人情報取り扱い');
...
──────────────────────
株式会社永和　代表取締役　桒木達夫
〒660-0843　兵庫県尼崎市東海岸町1-26
TEL：06-6409-1120 　FAX：06-6409-1150
E-mail：
URL：
──────────────────────
